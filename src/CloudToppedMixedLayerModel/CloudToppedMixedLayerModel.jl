...
ctbbl_variables = @variables begin
    ...
    (z_b(t) = 1200.0), [bounds = (600.0, 2000.0), description = "height of the cloud top = top of the boundary layer = at inversion, m"]
    ...
    T_lcl(t), [description = "temperature at the cloud base, K"]
